\label{subsec:sw2}
The smartwatch that was chosen to do the project with is the Sony SmartWatch 2. The smartwatch uses Bluetooth 3.0, it is relatively cheap and is programmable. The SDK has recently been updated and is easy to use. We have used the SDK to make an application. The installation given can be found at this website \cite{sw2_install}. These examples were used to generate traffic for the Ubertooth to understand the communications more easily as we would know exactly what is the content of the packets. This speeds up the process of finding targeting and decoding the packets. 
\begin{figure}[!h]
  \begin{center}
